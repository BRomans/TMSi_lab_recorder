...
function RecordTask(task_number, participant_name)
    ...
    try
        ...
        try
            ...
            poly5 = TMSi.Poly5('task_'+ task_number + '_' + participant_name +'.Poly5', 'Task ' + task_number + ' ' + participant_name, sampler.sample_rate, device.channels);
        ...
        ConvertToEEGLab('task_'+ task_number + '_' + participant_name +'.Poly5')
